...
const Navbar = () => {
  ...
  const toggleTheme = () => {
    ...
    if (darkMode === true) {
      ...
      headings.forEach((heading) => {
        heading.style.color = "white !important"; // Set your desired color for h2 elements
      });

      paragraphs.forEach((paragraph) => {
        paragraph.style.color = "white !important"; // Set your desired color for p elements
      });
    }
  };
  ...
  return (
    <div className="w-full bg-[#213644] text-white fixed z-10">
